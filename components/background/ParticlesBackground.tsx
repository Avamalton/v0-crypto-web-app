...
export default function ParticlesBackground({
...
}: CyberBackgroundProps & { children?: React.ReactNode }) {
  ...
  return (
    <div className={cn("relative w-full h-screen overflow-visible ", "bg-white dark:bg-black", className)}>
      <canvas ref={canvasRef} className="fixed inset-0 w-full h-full z-0" />
      <div className="relative z-10  items-center justify-center w-full h-full">
        {children || (
          <motion.div
